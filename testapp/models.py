...
class TestCycleTestCaseExecution(models.Model):
    ...
    case_execution_id = models.IntegerField(primary_key=True)
...
class UserToken(models.Model):
    ...
    field_create_time = models.DateTimeField(db_column='_create_time', blank=True, null=True)  # Field renamed because it started with '_'.
    create_micros = models.IntegerField(blank=True, null=True)
