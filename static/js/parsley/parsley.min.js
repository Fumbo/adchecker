...
!function (d) {
    var h = function (a) {
        this.messages = {defaultMessage: "Cette valeur semble être invalide.", type: {email: "Cette valeur doit être un email valide.", url: "Cette valeur doit être une url valide.", urlstrict: "Cette valeur doit être une url valide.", number: "Cette valeur doit être un nombre valide.", digits: "Cette valeur devait être des chiffres", dateIso: "Cette valeur doit être une date valide (AAAA-MM-JJ).", alphanum: "Cette valeur doit être alphanumérique.", phone: "Cette valeur doit être un numéro de téléphone valide"}, notnull: "Cette valeur ne doit pas être nul.",
            notblank: "Cette valeur ne doit pas être vide.", required: "Cette valeur est nécessaire.", regexp: "Cette valeur semble être invalide.", min: "Cette valeur doit être supérieure ou égale à %s.", max: "Cette valeur doit être inférieure ou égale à %s.", range: "Cette valeur doit être comprise entre% s et %s.", minlength: "Cette valeur est trop courte Il devrait avoir de %s caractères ou plus", maxlength: " Cette valeur est trop long Il devrait avoir %s caractères ou moins ", rangelength: "Cette longeur de valeur est invalide. Elle doit être comprise entre %s et %s de longeur.",
            mincheck: "Vous devez sélectionner au moins %s choix.", maxcheck: "Vous devez sélectionner %s choix ou moins.", rangecheck: "Vous devez sélectionner entre %s et %s choix.", equalto: "Cette valeur doit être identique"};
        this.init(a)
    };
